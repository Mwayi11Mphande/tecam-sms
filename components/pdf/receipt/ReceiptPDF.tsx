    ...
    <Document>
      <Page size="A7" style={styles.page}>
        ...
        <View style={styles.watermark}>
          <Text style={styles.watermarkText}>{shopName ? shopName.toUpperCase() : 'TECH STORE'}</Text>
        </View>
        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.title}>{shopName || 'TECH STORE MW'}</Text>
          </View>
          {shopAddress && <Text style={styles.subtitle}>{shopAddress}</Text>}
          <Text style={styles.subtitle}>{(shopPhone || shopEmail) ? [shopPhone, shopEmail].filter(Boolean).join(' | ') : '+265 881 234 567 | techstore.mw'}</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.blueText}>Cashier: {cashierName || 'System'}</Text>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text>For inquiries: {[shopEmail || 'support@techstore.mw', shopPhone ? `Call: ${shopPhone}` : '+265 881 234 567'].filter(Boolean).join(' | ')}</Text>
      ...
      if (printWindow) {
        printWindow.document.write(`
          ...
          <html>
            ...
            <body>
              <!-- Watermark -->
              <div class="watermark">${props.shopName ? props.shopName.toUpperCase() : 'TECH STORE'}</div>
              
              <div class="header">
                <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
                  <span class="logo">🛒</span>
                  <div class="title">${props.shopName || 'TECH STORE MW'}</div>
                </div>
                ${props.shopAddress ? `<div class="subtitle">${props.shopAddress}</div>` : ''}
                <div class="subtitle">${[props.shopPhone, props.shopEmail].filter(Boolean).join(' | ') || '+265 881 234 567 | techstore.mw'}</div>
                <div>
              ...
              <div>
                ...
                <div class="blue">Cashier: ${props.cashierName || 'System'}</div>
              </div>
              ...
              <div class="footer">
                ...
                <div>For inquiries: ${[props.shopEmail || 'support@techstore.mw', props.shopPhone ? `Call: ${props.shopPhone}` : '+265 881 234 567'].filter(Boolean).join(' | ')}</div>
